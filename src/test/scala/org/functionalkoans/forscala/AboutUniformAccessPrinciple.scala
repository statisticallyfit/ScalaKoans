...
class AboutUniformAccessPrinciple extends KoanSuite {
     ...
     koan("What happens when I update current year using property") {
          ...
          me.currentYear = 2011
          me.age should be(7) // doesn't change, because age is calculated at instantiation, and me obj was created already
     }
     ...
     koan("What happens when I update current year using method") {
          ...
          me.currentYear = 2011
          me.age should be(8) // changes since, calculated every time method is called
     }
